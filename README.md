...
- ptweights: pre-trained weights (use the darknet53.conv.74 weights downloaded, refer step 7 in (https://github.com/asceznyk/oddnet/blob/main/README.md#7-download-pre-trained-darknet53conv74-weights-for-custom-object-detection))
